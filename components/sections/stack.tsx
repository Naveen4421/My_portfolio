...
import { SiNextdotjs, SiTypescript, SiMongodb, SiKubernetes, SiPostgresql, SiTerraform, SiAnsible, SiPrometheus, SiGrafana, SiGithubactions, SiLinux } from "react-icons/si";
                                        ...
                                        <HoverCard key={item.name} openDelay={50} closeDelay={50}>
                                            <HoverCardTrigger asChild>
                                                <div className="group flex items-center gap-3 py-2.5 px-1 shrink-0 cursor-default">
                                                    <div className="transition-all duration-500 ease-out opacity-50 grayscale group-hover:grayscale-0 group-hover:opacity-100 group-hover:scale-110 text-xl flex items-center justify-center">
                                                        {iconMap[item.icon] || <span className="text-xl">🛠️</span>}
                                                    </div>
                                            ...
                                            >
                                                ...
                                                <div className="relative p-3 rounded-xl bg-secondary/50 ring-1 ring-border/50 shadow-inner group-hover:scale-110 transition-transform duration-500 text-4xl flex items-center justify-center">
                                                    {iconMap[item.icon] || <span className="text-4xl">🛠️</span>}
                                                </div>
